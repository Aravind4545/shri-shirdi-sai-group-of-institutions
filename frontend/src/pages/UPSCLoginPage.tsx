      ...
      <main className="flex-grow pt-32 pb-20 px-4 sm:px-6 lg:px-8 flex justify-center items-center">
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl w-full max-w-md border border-slate-200">
          <div className="mb-8 text-center">
            ...
            <p className="text-slate-500">Sign in to your UPSC Student Portal</p>
          </div>
          ...
          <div className="mt-8 text-center border-t border-slate-100 pt-6">
            ...
            <Link to="/upsc/register" className="text-blue-600 font-bold hover:underline">Register for UPSC</Link>
          </div>
          <div className="mt-4 text-center">
            <Link to="/upsc" className="inline-flex items-center text-sm text-slate-400 hover:text-slate-600 transition-colors">
              <ArrowLeft className="mr-1 w-4 h-4" /> Back to UPSC Program
            </Link>
          </div>
        </div>
      </main>
