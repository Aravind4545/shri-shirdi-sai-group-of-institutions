    ...
    <div className="min-h-screen flex flex-col bg-brand-light">
      ...
      <main className="flex-grow pt-32 pb-20 px-4 sm:px-6 lg:px-8 flex justify-center">
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl w-full max-w-4xl border border-gray-100">
          <div className="mb-8">
            <Link to="/lakshya" className="inline-flex items-center text-brand-blue hover:text-blue-800 transition-colors font-medium mb-6">
              <ArrowLeft className="mr-2 w-5 h-5" /> Back to Lakshya Program
            </Link>
            <h1 className="text-3xl md:text-4xl font-extrabold text-brand-dark mb-2">Student Registration</h1>
            <p className="text-gray-500">Program: <span className="font-bold text-brand-gold">Lakshya</span> | Stream: <span className="font-bold text-brand-gold">MPC</span></p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="pt-6 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between">
              <p className="text-gray-500 text-sm mb-4 md:mb-0">Already have an account? <Link to="/lakshya/login" className="text-brand-blue font-bold hover:underline">Log in</Link></p>
              <button 
                type="submit" 
                disabled={loading}
