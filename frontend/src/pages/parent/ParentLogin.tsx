...
const ParentLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans">`n      <div className="flex-grow flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-xl border border-slate-200">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-black tracking-tight text-slate-800">SSSI <span className="text-emerald-500">Parent</span></h1>
