              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {assignment.attachments.map((file: any, i: number) => (
                    <a key={i} href={`http://localhost:5001${file.url}`} target="_blank" rel="noreferrer" className="flex items-center gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-200 hover:border-blue-300 transition-colors group">
